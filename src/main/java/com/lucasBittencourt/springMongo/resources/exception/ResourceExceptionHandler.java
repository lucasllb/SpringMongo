package com.lucasBittencourt.springMongo.resources.exception;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandartError> objNotFound(ObjectNotFoundExcption e, HttpServletRequest request){
